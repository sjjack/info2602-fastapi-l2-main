...
@cli.command()
def get_user(username:str = typer.Argument(help="Users username to retrieve")
):
...
@cli.command()
def change_email(username: str =  typer.Argument(help="Username of the user"),
...
def create_user(username: str = typer.Argument(help= "Username for the new user "),
                email:str = type.Argument(help= "Email for the user"),
                password: str = type.Argument(help= "Password for user")
                ):
...
def list_users(
        limit: int = typer.Option(10, help=" Users to return (10)"), 
        offset:  int = typer.Option(0, help= " Users to skip (0)")):
        with get_session() as db:
            user = db.exec(
